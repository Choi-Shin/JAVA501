...
public class WildCardExample {
	...
	public static void main(String[] args) {
		Course<Person> p = new Course<Person>("일반인 과정", 5);
		p.add(new Person("일반인"));
		p.add(new Worker("직장인"));
		p.add(new Student("학생"));
		p.add(new HighStudent("고등학생"));
		
		Course<Worker> w = new Course<Worker>("직장인 과정", 5);
		w.add(new Worker("직장인"));
		
		Course<Student> s = new Course<Student>("학생 과정", 5);
		s.add(new Student("학생"));
		s.add(new HighStudent("고등학생"));
		
		Course<HighStudent> h = new Course<HighStudent>("직장인 과정", 5);
		h.add(new HighStudent("직장인"));
